...
// Copy Constructor by Ben Dahl. Following page 247 example
template<class ItemType>
LinkedList<ItemType>::LinkedList(const LinkedList<ItemType>& aList)
{
    // Lets get the pointer in the node to be copied
    Node<ItemType>* origChainPtr = aList.headPtr;
    
    if(origChainPtr == nullptr) // Check to see if its empty
        headPtr = nullptr;
    else
    {
        //Copy first node
...
// Overloaded Assignment operator by Ben Dahl.
template<class ItemType>
LinkedList<ItemType>& LinkedList<ItemType>::operator= (const LinkedList<ItemType>& aList)
{
    ...
    //Copy the right hand operand
    LinkedList<ItemType>* copy = new LinkedList<ItemType>(aList);
